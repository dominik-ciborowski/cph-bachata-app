  ...
  <div class="management-page">
    ...
    <section v-if="isOrganizer" class="card form auth-panel">
      <div>
        ...
        <p class="field-help">Choose the organizer that should be pre-filled when you add or import events.</p>
      </div>
      <form class="form" @submit.prevent="updateDefaultOrganizer">
        ...
        <button class="button" type="submit">Save default organizer</button>
